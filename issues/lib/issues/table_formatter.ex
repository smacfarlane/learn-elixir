defmodule Issues.TableFormatter do
  ...
  identified by each eader. That is, each header identifies a column,
  ...
  @doc """
  Given a list of forws, where each row contains a keyed list
  ...
  hyphens, with + signs where the virtical bar between the columns goes.
